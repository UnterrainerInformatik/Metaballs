...
namespace Utilities
{
    public static class Primitives2D
    {
        ...
        private static bool EqualsZero(this float value)
        {
            return Equals(value, 0f);
        }

        private static bool Equals(float firstValue, float secondValue, float epsilon = float.Epsilon)
        {
        ...
        public static void FillRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float layerDepth)
        {
            ...
            spriteBatch.Draw(spriteBatch.GetWhitePixel(), rect, null,
                ...
                layerDepth: layerDepth.EqualsZero() ? 0f : 1f / layerDepth);
        }
            ...
            float thickness, float layerDepth)
        {
            ...
            spriteBatch.Draw(spriteBatch.GetWhitePixel(),
                ...
                effects: SpriteEffects.None, layerDepth: layerDepth.EqualsZero() ? 0f : 1f / layerDepth);
        }
